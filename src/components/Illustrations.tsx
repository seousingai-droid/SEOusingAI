...
export function SampleReport() {
  ...
  return (
    <div role="img" aria-label="Example of a checklist report with a score of 72 out of 100 and five results: two passed, one could be better, two need fixing" className="card p-6 shadow-[0_40px_120px_-40px_rgb(255_216_77/0.25)] sm:p-7">
      <div className="flex items-center gap-5 border-b border-line pb-5">
        <div className="relative h-[84px] w-[84px] shrink-0">
          ...
          <span className="absolute inset-0 grid place-items-center font-[family-name:var(--font-display)] text-[26px] font-bold">72</span>
        </div>
      ...
      <p className="mt-3 font-mono text-[11px] text-muted">Example report. Yours is built from your real page.</p>
    </div>
  );
}
