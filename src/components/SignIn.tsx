...
export default function SignIn({ onSignedIn, website = "", title = "Create your free account", blurb = "Enter your email and we will send you a 6-digit code. No password to remember, no card." }: {
  onSignedIn: (s: Session) => void; website?: string; title?: string; blurb?: string;
}) {
    ...
    <div className="card overflow-hidden">
      <div className="p-7 sm:p-9">
        {step === "email" ? (
          ...
          <>
            <h2 className="text-[clamp(22px,2.6vw,28px)] font-bold">{title}</h2>
