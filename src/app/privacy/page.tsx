...
export default function Page() {
  return (
    <Simple name="Privacy policy" href="/privacy" eyebrow="Legal" title="Privacy policy">
      ...
      <p>This site has no accounts, no sign-up, and no comment system. The free tools run entirely in your browser, and what you type into them is never sent to us.</p>
      ...
      <p>The site sets no cookies of its own, and there are no advertising or tracking cookies. If you click an affiliate link, the destination site may set its own cookies under its own privacy policy.</p>
