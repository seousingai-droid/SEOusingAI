...
export default function Page() {
  return (
    <Simple name="Privacy policy" href="/privacy" eyebrow="Legal" title="Privacy policy">
      ...
      <p>This site has no accounts, no signup forms, and no comment system. The free tools run in your browser, and what you type into them is not sent to or stored on our servers.</p>
