  ...
  return (
    <ToolShell
      ...
      how={[
        ...
        { h: "Does llms.txt improve AI visibility?", p: "llms.txt may help AI systems understand your site, but adoption by AI companies is uneven and no major engine has confirmed it as a ranking or citation factor. Because it takes minutes to create, most sites add one as a low-cost signal and do not rely on it." },
