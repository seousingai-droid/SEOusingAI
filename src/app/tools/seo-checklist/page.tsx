  ...
  return (
    <ToolShell
      ...
      how={[
        ...
        { h: "What is free and what is paid?", p: `A free account, which takes one email and no password, gives you the first ${5} results on every report, your score, and the names of the three things to fix first. One payment of $67 unlocks all 94 results, with a fix for each, forever. There is no subscription.` },
      ...
      faqs={[
        { q: "Is the SEO checklist tool free?", a: "The first 5 results of every report are free once you create a free account with your email, and you can check as many pages as you like. Seeing all 94 results costs $67 once, with no subscription." },
