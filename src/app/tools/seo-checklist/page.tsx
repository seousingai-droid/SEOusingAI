...
export const metadata = pageMeta({
  ...
  description: "Enter your website and get an SEO checklist report: 94 checks for Google and AI search, each explained in plain English with a fix. First 5 free.",
  ...
  return (
    <ToolShell
      ...
      how={[
        ...
        { h: "What is free and what is paid?", p: `A free account, which takes one email and no password, checks one page and gives you the first ${5} results, your score, and the names of the three things to fix first. One payment of $67 unlocks all 94 results, with a fix for each, forever. There is no subscription.` },
      ...
      faqs={[
        { q: "Is the SEO checklist tool free?", a: "Yes, for one page at a time: create a free account with your email and you see the 5 most important results. Auditing every page of your website and seeing all 94 results starts at $39, paid once." },
        { q: "Do you store my website address or results?", a: "No. Your website address is sent to our server so it can open the page, and the report is sent back to your browser. We keep no copy of either. Your email is kept so we can sign you in, and your saved audit history stays in your own browser." },
