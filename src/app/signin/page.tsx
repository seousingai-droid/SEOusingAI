...
export const metadata: Metadata = {
  ...
  description: "Create a free account to use the SEO Using AI tools: a Google snippet preview, an AI SEO prompt builder, and an llms.txt generator.",
...
export default function Page() {
  return (
    <>
      <PageHero eyebrow="Account" crumbs={[{ name: "Sign in", href: "/signin" }]}
        title={<>One free account, <span className="hl">every tool</span></>}
        lede="Enter your email and we send you a 6-digit code. No password to remember, and no card." />
